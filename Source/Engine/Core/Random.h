...
namespace bonzai::random {
    ...
    /// <summary>
    /// Returns an integer in the range [0, max - 1].
    /// </summary>
    /// <param name="max">The exclusive upper bound for the returned integer.</param>
    /// <returns>An integer greater than or equal to 0 and less than max.</returns>
    ...
    /// </summary>
    /// <typeparam name="T">The type of the real number to generate. Defaults to float.</typeparam>
    /// <param name="max">The upper bound for the generated real number.</param>
